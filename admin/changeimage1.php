...
$sql="update tblmentors set Vimage1=:vimage1 where id=:id";
...
<head>
	...
	<title>Update Image | Mentor Portal</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Profile Image</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Profile Image Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage1 from tblmentors where tblmentors.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
