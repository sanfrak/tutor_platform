...
$SessionPrice=$_POST['priceperday'];
$DegreeType=$_POST['fueltype'];
$EnrolledYear=$_POST['modelyear'];
//$Rating=$_POST['seatingcapacity'];
...
#$sql="update tblmentors set MentorName=:vehicletitle,University=:brand,SelfDescription=:vehicleoverview,SessionPrice=:SessionPrice,DegreeType=:DegreeType,EnrolledYear=:EnrolledYear,Rating=:Rating,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
$sql="update tblmentors set MentorName=:vehicletitle,University=:brand,SelfDescription=:vehicleoverview,SessionPrice=:SessionPrice,DegreeType=:DegreeType,EnrolledYear=:EnrolledYear,Rating=5 where id=:id ";
$query = $dbh->prepare($sql);
$query->bindParam(':vehicletitle',$vehicletitle,PDO::PARAM_STR);
$query->bindParam(':brand',$brand,PDO::PARAM_STR);
$query->bindParam(':vehicleoverview',$vehicleoverview,PDO::PARAM_STR);
$query->bindParam(':SessionPrice',$SessionPrice,PDO::PARAM_STR);
$query->bindParam(':DegreeType',$DegreeType,PDO::PARAM_STR);
$query->bindParam(':EnrolledYear',$EnrolledYear,PDO::PARAM_STR);
...
<head>
	...
	<title>Edit Profile | Mentor Portal</title>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT tblmentors.*,tbluniv.UniversityName,tbluniv.id as bid from tblmentors join tbluniv on tbluniv.id=tblmentors.University where tblmentors.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<label class="col-sm-2 control-label">Mentor Name<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->MentorName)?>" required>
</div>
<label class="col-sm-2 control-label">Select University<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="brandname" required>
<option value="<?php echo htmlentities($result->bid);?>"><?php echo htmlentities($bdname=$result->UniversityName); ?> </option>
<?php $ret="select id,UniversityName from tbluniv";
...
<div class="form-group">
<label class="col-sm-2 control-label">Self-Description<span style="color:red">*</span></label>
<div class="col-sm-10">
<textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo htmlentities($result->SelfDescription);?></textarea>
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Session Price<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="SessionPrice" class="form-control" value="<?php echo htmlentities($result->SessionPrice);?>" required>
</div>
<label class="col-sm-2 control-label">Select Degree Type<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="DegreeType" required>
<option value="<?php echo htmlentities($results->DegreeType);?>"> <?php echo htmlentities($result->DegreeType);?> </option>

<option value="Petrol">Bachelor</option>
<option value="Diesel">Master</option>
<option value="CNG">Ph.D</option>
</select>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Enrolled Year<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="EnrolledYear" class="form-control" value="<?php echo htmlentities($result->EnrolledYear);?>" required>
</div>

<!--
<label class="col-sm-2 control-label">Rating<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="Rating" class="form-control" value="<?php echo htmlentities($result->Rating);?>" required>
</div>
-->
