...
header('location:index.php');
	...
	#$uNm = strval($_SESSION['alogin']);
	#echo '<script type="text/javascript">alert("'.$uNm.'");</script>';
	#sleep(1);
...
<head>
	...
	<title>Dashboard | Mentor Portal</title>
...
$sql1 ="SELECT id from tblmentors where Mid=:aid";
...
?>
											...
											<a href="manage-mentor.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
$sql2 ="SELECT id from tblsessions where mentorid=:aid";
