...
if(isset($_POST['updateprofile']))
  {
    ...
    ### need editing
    $sql="update tblusers set website=:uwebsite,gender=:ugender,FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";

$query = $dbh->prepare($sql);
###added attributes
$query->bindParam(':uwebsite',$uwebsite,PDO::PARAM_STR);
$query->bindParam(':ugender',$ugender,PDO::PARAM_STR);
###
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <!--
                HERE goes the Editing of GENDER!
                $ugender=$_POST['gender'];
              -->
              <?php 
                $gender = "";
            ...
            <div class="form-group">
              ...
              <!--
                HERE goes the Editing of website!
                $uwebsite=$_POST['website'];
              -->
            <div class="form-group">
              <label class="control-label">Website</label>
              <input class="form-control white_bg" name="website" value="<?php echo htmlentities($result->website);?>" id="website" type="text" required>
            </div>
            <div class="form-group">
