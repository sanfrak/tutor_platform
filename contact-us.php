...
if($lastInsertId)
{
$msg=" Thank you for your feedback! We will contact you shortly";
}
else 
{
        ...
        <div class="contact_detail">
          <ul>
            <li>
              ...
              <div class="contact_info_m"><a href="mailto:dbg5@uva.edu">dbg5@uva.edu</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:">+1-434-982-2200</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="Address:">CS6501 DB_Group5, Rice Hall, Charlottesville, VA 22903</a></div>
            </li>
          </ul>
        </div>
      </div>
